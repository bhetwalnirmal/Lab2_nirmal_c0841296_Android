package com.nirmalbhetwal.lab2_nirmal_c0841296_android.listeners;
...
public class ProductListTouchListener implements RecyclerView.OnItemTouchListener, OnDashboardTouchListener {
    private static final String TAG = "ProductListTouchListener";
...
//                    vibe.vibrate(100); // do we really need to add vibrate service
    ...
    public ProductListTouchListener(Activity a, RecyclerView recyclerView) {
        this.act = a;
...
//        mSwipeListener = listener;
        ...
        rView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                /**
                 * This will ensure that this ProductListTouchListener is paused during recycler view scrolling.
    ...
    public ProductListTouchListener setClickable(OnRowClickListener listener) {
        this.clickable = true;
        this.mRowClickListener = listener;
        return this;
    }

    public ProductListTouchListener setClickable(boolean clickable) {
        this.clickable = clickable;
        return this;
    }

    public ProductListTouchListener setLongClickable(boolean vibrate, OnRowLongClickListener listener) {
        this.longClickable = true;
        this.mRowLongClickListener = listener;
        this.longClickVibrate = vibrate;
        return this;
    }
    public ProductListTouchListener setLongClickable(boolean longClickable) {
        this.longClickable = longClickable;
        return this;
    }

    public ProductListTouchListener setIndependentViews(Integer... viewIds) {
        this.independentViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
    }

    public ProductListTouchListener setUnClickableRows(Integer... rows) {
        this.unClickableRows = new ArrayList<>(Arrays.asList(rows));
        return this;
    }

    public ProductListTouchListener setIgnoredViewTypes(Integer... viewTypes) {
    ...
    public ProductListTouchListener setSwipeable(int foregroundID, int backgroundID, OnSwipeOptionsClickListener listener) {
        this.swipeable = true;
        ...
        if (act instanceof ProductListTouchListenerHelper)
            ((ProductListTouchListenerHelper) act).setOnActivityTouchListener(this);
    ...
    public ProductListTouchListener setSwipeable(boolean value) {
    ...
    public ProductListTouchListener setSwipeOptionViews(Integer... viewIds) {
        this.optionViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
    }

    public ProductListTouchListener setUnSwipeableRows(Integer... rows) {
    ...
    public ProductListTouchListener setViewsToFade(Integer... viewIds) {
        this.fadeViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
    }

    // the entire foreground is faded out as it is opened
    public ProductListTouchListener setFgFade() {
...
//                        }
    ...
    public interface ProductListTouchListenerHelper {
        void setOnActivityTouchListener(OnDashboardTouchListener listener);
    }
